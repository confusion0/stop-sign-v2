...
module.exports = {
  ...
  run: async(client) => {
    ...
    client.gData.on('error', err => console.error('[ERROR] Keyv guild data connection error:', err));
    client.uData.on('error', err => console.error('[ERROR] Keyv user data connection error:', err));
  }
}
