...
module.exports = {
    ...
    description: 'Resume a giveaway on the server!',
    options: [
        {
            name: 'message-id',
    ...
    run: async (client, interaction, args) => {
        ...
        .then(() => {
            // Success message
            interaction.followUp({ content: `The giveaway has been successfully resumed.` });
        })
        .catch((e) => {
            interaction.followUp({ content: `An error occured while resuming the giveaway. \nIt is possible that you tried to resume a giveaway before after it has ended or you tried to un-pause a giveaway that was not paused.` });
        });
    }
}
