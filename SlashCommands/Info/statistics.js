const { EmbedBuilder, Client, ApplicationCommandType, ApplicationCommandOptionType } = require('discord.js')
...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        cpuStat.usagePercent(function (error, percent, seconds) {
            ...
            .setTitle('Statistics')
            .addFields([
                { name: 'Bot Statistics:', value: `Servers: ${guild} \nUsers: ${user} \nChannels: ${channel} \nUsage: ${usage} \nNode: ${Node} \nCPU Usage: ${CPU}%`},
                { name: 'Physical Statistics:', value: `CPU: ${cores} - ${cpuModel}  \nUptime: **${parseDur(client.uptime)}**` }
            ])
            .setColor('Blurple')
